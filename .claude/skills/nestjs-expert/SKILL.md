...
- Use Guards for authorization, Pipes for validation, Interceptors for transformation
- Organize code by feature modules following NestJS conventions
...
- Use single quotes, trailing commas, and semicolons
- Prefer `for...of` loops over `array.forEach()`
- Avoid `array.reduce()` - use more readable alternatives
- No `any` types - use proper TypeScript typing
- Add padding lines before return statements and blocks
...
- Skip error handling
- Use default exports (ESLint rule)
